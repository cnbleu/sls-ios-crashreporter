...
https://help.aliyun.com/product/28958.html
  ...
  spec.source  = { :git => 'git@github.com:cnbleu/sls-ios-crashreporter.git', :tag => spec.version.to_s }
  ...
  spec.source_files = "AliyunLogCrashReporter/*.{h,m}", "AliyunLogCrashReporter/parser/*.{h,m}", "AliyunLogCrashReporter/sender/*.{h,m}"
