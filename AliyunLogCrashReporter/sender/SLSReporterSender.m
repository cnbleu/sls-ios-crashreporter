...
- (void)initWithSLSConfig:(SLSConfig *)config {
    ...
    LogProducerConfig *logConfig = [[LogProducerConfig alloc] initWithEndpoint:endpoint project:project logstore:logstore accessKeyID:config.accessKeyId accessKeySecret:config.accessKeySecret securityToken:config.securityToken];
